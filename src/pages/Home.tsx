...
export default function Home({ isAdmin }: { isAdmin: boolean }) {
  ...
  return (
    <div className="min-h-screen bg-luxury-black text-zinc-900 font-sans overflow-x-hidden">
      <Seo
        title="오사카 한인 부동산·유학생·워홀 정착 매물 상담"
        description="오사카J부동산은 오사카 한인, 유학생, 워홀러, 일본 정착 예정자를 위한 부동산 상담 서비스입니다. 주거용 맨션, 타워맨션, 상가, 사무실, 수익형 부동산 매물을 한국어로 안내합니다."
        keywords="오사카부동산, 오사카 J 부동산, 오사카J부동산, 오사카 한인 부동산, 오사카 유학생 집, 오사카 워홀 집, 오사카 맨션, 오사카 타워맨션, 오사카 상가, 오사카 사무실, 일본 부동산, 오사카 정착"
        canonical="https://osaka-j.pages.dev/"
        image="https://osaka-j.pages.dev/favicon.PNG"
        structuredData={{
          '@context': 'https://schema.org',
          '@type': ['RealEstateAgent', 'LocalBusiness'],
          '@id': 'https://osaka-j.pages.dev/#business',
          name: '오사카J부동산',
          alternateName: ['Osaka J Real Estate', '行政書士Legal_ J office 부동산 서비스'],
          url: 'https://osaka-j.pages.dev/',
          logo: 'https://osaka-j.pages.dev/favicon.PNG',
          image: 'https://osaka-j.pages.dev/favicon.PNG',
          description: '오사카J부동산은 오사카 한인, 유학생, 워홀러, 일본 정착 예정자를 위한 부동산 상담 서비스입니다.',
          ...
          address: {
            ...
            streetAddress: '福島7丁目20-18 シティタワー西梅田4203号',
            addressCountry: 'JP',
          },
          areaServed: [
          ...
          sameAs: [
            'https://legalj.jp/',
            'https://www.instagram.com/oosaka_j/',
            'https://youtube.com/channel/UC7DZHrosVAYHdfP6VzSPvog',
          ],
          makesOffer: [
            {
              '@type': 'Offer',
              itemOffered: {
                '@type': 'Service',
                name: '오사카 부동산 매물 상담',
                description: '오사카 주거용 맨션, 타워맨션, 상가, 사무실, 수익형 부동산 매물 상담',
              },
            },
            {
              '@type': 'Offer',
              itemOffered: {
                '@type': 'Service',
                name: '오사카 정착 부동산 상담',
                description: '유학생, 워홀러, 일본 정착 예정자를 위한 부동산 상담',
              },
            },
          ],
        }}
