...
const Recruitment = () => {
  ...
  return (
    <div className="min-h-screen bg-luxury-black text-white font-sans selection:bg-blue-600/30">
      <Seo
        title="오사카J부동산 채용 정보·Legal J Office 인재 모집"
        description="오사카J부동산과 行政書士Legal_ J office의 채용 정보 페이지입니다. 일본 부동산 전담팀, 행정서사 서포터, 법무팀, 디지털 마케터, 콘텐츠 제작 인재를 모집합니다."
        keywords="오사카 채용, 오사카 한인 채용, 일본 부동산 채용, 오사카J부동산 채용, Legal J Office 채용, 행정서사 사무소 채용, 오사카 아르바이트, 오사카 업무위탁, 일본 취업"
        canonical="https://osaka-j.pages.dev/recruitment"
        image="https://osaka-j.pages.dev/favicon.PNG"
        structuredData={{
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          '@id': 'https://osaka-j.pages.dev/recruitment#webpage',
          name: '오사카J부동산 채용 정보',
          url: 'https://osaka-j.pages.dev/recruitment',
          description: '오사카J부동산과 行政書士Legal_ J office의 채용 정보 페이지입니다.',
          isPartOf: {
            '@type': 'WebSite',
            name: '오사카J부동산',
